...
private:
    int Step1(const DSL_dataset &ds, DSL_pattern &pat, DSL_learnProgress *progress = NULL) const;
    int Step2(const DSL_dataset &ds, DSL_pattern &pat, DSL_learnProgress *progress = NULL) const;
    int Step3(const DSL_dataset &ds, DSL_pattern &pat, DSL_learnProgress *progress = NULL) const;
    int Step4PC(const DSL_dataset &ds, DSL_pattern &pat, DSL_learnProgress *progress = NULL) const;
    int Step4FCI(const DSL_dataset &ds, DSL_pattern &pat, DSL_learnProgress *progress = NULL) const;
    int Step5FCI(const DSL_dataset &ds, DSL_pattern &pat, DSL_learnProgress *progress = NULL) const;
